...
const TESTS = [
  ...
  },
  {
    ...
    description: 'Bes Faktor Kisilik Modeli ile kendinizi taniyin. Disadonukluk, Uyumluluk, Sorumluluk, Duygusal Denge ve Aciklik kategorilerinde detayli analiz.',
    icon: Brain,
    duration: '15-20 dk',
    questions: 50,
    color: 'from-purple-500 to-indigo-600',
    available: true,
    academic: 'Costa & McCrae (1992)',
  },
  {
    ...
    available: true,
    academic: 'Bar-On (1997)',
  },
  {
    id: 'leadership',
    title: 'Liderlik Stili Analizi',
    description: 'Liderlik yaklasiminiizi kesfetdin: Donusumcu, Islemci, Hizmetkar veya Vizyoner.',
    icon: ClipboardList,
    duration: '10-15 dk',
    questions: 25,
    color: 'from-amber-500 to-orange-600',
    available: false,
    academic: 'Bass & Avolio (1994)',
  },
];
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-10">
            ...
            >
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <span className="text-sm text-primary font-medium">Akademik Tabanli Testler</span>
              </div>
              <h1 className="text-3xl sm:text-4xl font-bold mb-4">
                Kisilik Envanterleri
              </h1>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Bilimsel olarak gecerliligi kanitlanmis kisilik testleri ile kendinizi daha iyi taniyin.
                AI destekli detayli raporlar ve kisisel gelisim onerileri.
              </p>
            </motion.div>
          </div>
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-medium mb-1">Her test 1 seans hakki kullanir</h3>
                <p className="text-sm text-muted-foreground">
                  Test tamamlandiginda seans hakkinizdan 1 adet dusulur. Karsiliginda detayli AI raporu,
                  grafikler ve PDF ciktisi alirsiniz.
                </p>
              </div>
            </div>
          </motion.div>
